        ...
        <main className={` relative text-white font-Roboto `}>
            <section className={` h-screen relative w-full bg-cover bg-center bg-black overflow-hidden  `} id={`inicio`}>
                ...
                <div className={` relative mx-auto flex flex-col w-full h-full items-center justify-center px-4`}>
                    <h2 data-aos-duration="3618" data-aos-once="true" data-aos='fade-right' className={` max-w-5xl text-left w-full transition-all ease-in-out text-5xl md:text-6xl lg:text-7xl font-bold lg:my-0 opacity-80`}>En<Image className={` inline-block h-16 md:h-20 lg:h-24 w-auto `} priority src={impulso360Logo} alt='' /></h2>
                    <h3 data-aos-duration="3618" data-aos-once="true" data-aos='fade-right' className={` font-RobotoCondensed max-w-5xl text-left w-full transition-all ease-in-out text-2xl md:text-3xl lg:text-4xl font-light lg:my-0 opacity-80 `}>comienza tu transformación digital hoy</h3>
                    <p data-aos-duration="3618" data-aos-once="true"  data-aos='fade-right' className={` max-w-5xl text-left w-full text-lg mt-3 md:mt-4 lg:mt-6 `}><Link className={` inline-block transition-all ease-in-out duration-200 text-white no-underline font-medium opacity-80 text-lg lg:text-xl hover:translate-y-1 `} href='#serviciosIntegrales' ><Image className={` inline-block mr-3 h-5 w-auto `} src={anglesDown} alt='Angles Down' /> Conoce más aquí <Image className={` inline-block ml-3 h-5 w-auto`} src={anglesDown} alt='Angles Down' /></Link></p>
