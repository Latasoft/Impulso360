        ...
        <main className={` text-white font-Roboto  sm:mt-16  lg:mt-20`}>
            <section className={` h-screen relative w-full bg-cover bg-center bg-black overflow-hidden`} >
                ...
                <div className={` relative mx-auto flex flex-col w-full h-full items-center justify-center px-4`}>
                    <h2 className={` max-w-5xl text-left w-full transition-all ease-in-out duration-100 text-4xl  lg:text-5xl font-bold my-2 opacity-80`}>En Impulso 360</h2>
                    <h3 className={` max-w-5xl text-left w-full transition-all ease-in-out duration-100 text-2xl lg:text-3xl font-semibold my-2 opacity-80 `}>comienza tu transformación digital hoy</h3>
                            ...
                            <div key={index} className={` w-full bg-cover bg-center `} style={{ backgroundImage: `url('${item.fondoImagen.src}')`, }}>
                                <div className={` py-28 md:px-4 lg:px-8 xl:px-16 text-center`}>
                                    <div className={`py-6 bg-black bg-opacity-60`}>
                                        <h3 className={` transition-all ease-in-out duration-100 text-3xl lg:text-4xl font-semibold mx-4 my-8 `}>{item.titulo}</h3>
