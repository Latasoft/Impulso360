        ...
        <main className={` relative text-white font-Roboto `}>
            <section className={` h-screen relative w-full bg-cover bg-center bg-black overflow-hidden  `} id={`inicio`}>
                ...
                <div className={` relative mx-auto flex flex-col w-full h-full items-center justify-center px-4`}>
                    <h2 data-aos-duration="3618" data-aos-once="true" data-aos='fade-right' className={` max-w-5xl text-left w-full transition-all ease-in-out text-5xl md:text-6xl lg:text-7xl font-bold lg:my-0 opacity-80`}>En<Image className={` inline-block h-16 md:h-20 lg:h-24 w-auto `} src={impulso360Logo} alt='' /></h2>
